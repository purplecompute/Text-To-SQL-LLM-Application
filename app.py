...
st.markdown("""
    <div style='text-align: center; margin-top: 50px;'>
        <p>
            <img src='https://raw.githubusercontent.com/purplecompute/Text-To-SQL-LLM-Application/master/Media/sparkling_ai_icon.png' alt='Sparkling AI logo' width='17' style='vertical-align: middle;' />
            Developed By: Mayur Satao
        </p>
        <p>
            <a href='https://github.com/purplecompute' target='_blank'>
                <img src='https://raw.githubusercontent.com/purplecompute/Text-To-SQL-LLM-Application
